...
public abstract class AbstractBeanDefinition extends BeanMetadataAttributeAccessor
	 ...
	 * 返回已解析的autowire代码（将AUTOWIRE_AUTODETECT解析为AUTOWIRE_CONSTRUCTOR or AUTOWIRE_BY_TYPE
	 *
	 * @see #AUTOWIRE_AUTODETECT
	 * @see #AUTOWIRE_CONSTRUCTOR
	 * @see #AUTOWIRE_BY_TYPE
	...
	public int getResolvedAutowireMode() {
		if (this.autowireMode == AUTOWIRE_AUTODETECT) {
			...
			//	确定是应用setter autowiring还是constructor autowiring。
			//	如果它有一个无arg构造函数，它被认为是setter autowiring，
			//	否则我们将尝试构造函数自动连线
	 ...
	 * 验证并准备为此BeanDefinition的方法重写。检查是否存在具有指定名称的方法
	 *
	 * @throws BeanDefinitionValidationException in case of validation failure
	 */
