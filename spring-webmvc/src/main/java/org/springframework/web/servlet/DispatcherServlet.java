...
public class DispatcherServlet extends FrameworkServlet {
	 ...
	 * <p>
	 * 此命名空间的bean工厂中HandlerMapping对象的已知名称。仅在关闭“DetectalHandlerMappings”时使用
	 *
	 ...
	 *
	 * 此命名空间的bean工厂中HandlerAdapter对象的已知名称。仅在关闭“DetectalHandlerAdapters”时使用
	 *
